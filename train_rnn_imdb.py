...
from minGRU_pytorch.CustomRNN import CustomRNN
...
writer = SummaryWriter("runs/imdb_simple_rnn")
...
model = CustomRNN(512, 512, 2, num_tokens=VOCAB_SIZE, sub_nn=SUB_FF).cuda()

# model = minGRUC(
#     num_tokens=VOCAB_SIZE, dim=512, depth=DEPTH, substitute_ff=SUB_FF
# ).cuda()
